...
void loop() {
  ...
  //センサー
  int sensorRound = digitalRead(8);
  int sensorFlat = digitalRead(9);
  int sensorCome = digitalRead(10);
  int sensorRun = digitalRead(11);
